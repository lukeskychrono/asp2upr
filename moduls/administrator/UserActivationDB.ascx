...
<div id="newUAModal" class="modal fade">
	<div class="modal-dialog modal-confirm">
		<div class="modal-content">
			<div class="modal-header">		
				<h4 class="modal-title">Add a new UA</h4>	
			</div>
			...
			<div class="modal-footer">
                <asp:Button ID="NewUAButton" CssClass ="btn btn-success btn-block" runat="server" data-dismiss="modal" Text="Добави"/>
			</div>
		</div>
	</div>
</div>
<div id="editUAModal" class="modal fade">
	<div class="modal-dialog modal-confirm">
		<div class="modal-content">
			<div class="modal-header">
                <asp:HiddenField ID="hiddenUAId" runat="server" />
				<h4 class="modal-title">Edit UA</h4>	
			</div>
			<div class="modal-body">
                 <label class="col-form-label">Role Name:</label>
			...
			<div class="modal-footer">
                <asp:Button ID="EditUAButton" CssClass ="btn btn-success btn-block" runat="server" data-dismiss="modal" Text="Добави"/>
                 <asp:Button ID="DeleteUAButton" CssClass ="btn btn-danger btn-block pull-left" runat="server" data-dismiss="modal" Text="Добави"/>
			</div>
		</div>
	</div>
</div> 
    ...
    <asp:GridView CssClass="table table-hover" Width="100%" ID="GridView1" runat="server" DataSourceID="SDS_ActivationUser" AutoGenerateColumns="False" DataKeyNames="Id" AllowPaging="True">
        <Columns>
            ...
            <asp:BoundField DataField="RoleId" HeaderText="RoleId" SortExpression="RoleId"></asp:BoundField>
             <asp:TemplateField>
                <ItemTemplate>
                    <asp:LinkButton ID="editBtn" runat="server" CommandArgument='<%# Eval("Id") %>'>Edit</asp:LinkButton>
